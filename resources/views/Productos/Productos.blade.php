        ...
        <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
                ...
                @foreach ($producto as $product)
                    <div
                        ...
                        <div class="h-56 w-full">
                            <a href="#">
                                <img class="mx-auto h-full dark:hidden" src="{{ $product->imagen }}"
                                    alt="{{ $product->imagen }}" />
                                <img class="mx-auto hidden h-full dark:block" src="{{ $product->imagen }}"
                                    alt="{{ $product->imagen }}" />
                            </a>
                        </div>
                        <div class="pt-6">
                            ...
                            <div class="mt-2 flex items-center gap-2">
                                ...
                                <p class="text-sm font-medium text-gray-900 dark:text-white">Stock</p>
                            ...
                            <ul class="mt-2 flex items-center gap-4">
                                <li class="flex items-center gap-2">
                                    ...
                                    <p class="text-sm font-medium text-gray-500 dark:text-gray-400">{{ $product->Estado }}
                                    </p>
                                </li>
                                ...
                                <li class="flex items-center gap-2">
                                    ...
                                    <p class="text-sm font-medium text-gray-500 dark:text-gray-400">ID Categoria
                                        {{ $product->Categoria_id }}</p>
                                </li>
                            </ul>
            ...
            <div class="w-full text-center">
                <button type="button"
                    ...
                    more</button>
                <a href="/Aproducto"
                    class="rounded-lg border border-gray-200 bg-white px-5 py-2.5 text-sm font-medium text-gray-900 hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-100 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:ring-gray-700">Añadir
                    un producto</a>
