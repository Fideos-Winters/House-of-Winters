...
<section class="bg-white dark:bg-gray-900">
  <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
      <div class="mx-auto mb-8 max-w-screen-sm lg:mb-16">
          <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Nuestro Distinguido Equipo</h2>
          

          <p class="font-light text-gray-500 sm:text-xl dark:text-gray-400">Conozca a los miembros de nuestro noble establecimiento, dedicados al arte de la preparación de infusiones y repostería fina con la elegancia propia en si misma.</p>
      </div> 
      ...
      <div class="text-center text-gray-500 dark:text-gray-400">
              ...
              <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                  <a href="#">{{ $empl->Nombres }} {{ $empl->Apellidos }}</a>
              </h3>
              <p>{{ $empl->Rol }}</p>
              <ul class="flex justify-center mt-4 space-x-4">
                  <li>
                      <a href="/Equipo/{{$empl -> ID}}/editar" class="text-[#39569c] hover:text-gray-900 dark:hover:text-white"> Editar
                      </a>
                  </li>
                  <li>
                                    <form action="/Equipo/{{ $empl->ID }}/eliminar" method="POST" style="display:inline;">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit"
